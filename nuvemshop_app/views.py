...
def integracao(request):
    ...
    if code is not None:
        ...
        return render(
            request, "nuvemshop_app/integracao.html", {"loja_integrada": loja_integrada}
        )
    ...
    if id:
        ...
        if LojaIntegrada.objects.filter(id=id).exists():
            ...
            if hasattr(usuario, "profile") and usuario.profile.loja is None:
                ...
                usuario.profile.loja = (
                    nova_loja  # Associando a nova loja ao perfil do usuário
                )
                ...
                return render(
                    ...
                    "nuvemshop_app/integracao.html",
                    {
                        "lj_integrada": lj_integrada,
                        "erro": "Usuário já possui uma loja integrada.",
                    },
                )
